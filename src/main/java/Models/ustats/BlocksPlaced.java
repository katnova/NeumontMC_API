...
public class BlocksPlaced implements Serializable
{
    ...
    private final static long serialVersionUID = -8570787645411075036L;
    ...
    public BlocksPlaced withAmount(Long amount) {
        this.amount = amount;
        return this;
    }
    ...
    public BlocksPlaced withBlocks(String blocks) {
        this.blocks = blocks;
        return this;
    }
    ...
    public BlocksPlaced withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BlocksPlaced) == false) {
            return false;
        }
        BlocksPlaced rhs = ((BlocksPlaced) other);
