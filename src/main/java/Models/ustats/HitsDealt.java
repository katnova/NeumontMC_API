...
public class HitsDealt implements Serializable
{
    ...
    private final static long serialVersionUID = -7645743478437906737L;
    ...
    public HitsDealt withAmount(Long amount) {
        this.amount = amount;
        return this;
    }
    ...
    public HitsDealt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HitsDealt) == false) {
            return false;
        }
        HitsDealt rhs = ((HitsDealt) other);
