...
public class DeathsByPlayer implements Serializable
{
    ...
    private final static long serialVersionUID = -7622973552210908402L;
    ...
    public DeathsByPlayer withAmount(Long amount) {
        this.amount = amount;
        return this;
    }
    ...
    public DeathsByPlayer withPlayers(String players) {
        this.players = players;
        return this;
    }
    ...
    public DeathsByPlayer withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeathsByPlayer) == false) {
            return false;
        }
        DeathsByPlayer rhs = ((DeathsByPlayer) other);
