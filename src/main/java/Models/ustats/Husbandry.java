...
public class Husbandry implements Serializable
{
    ...
    private final static long serialVersionUID = -7978367611661056904L;
    ...
    public Husbandry withAmount(Long amount) {
        this.amount = amount;
        return this;
    }
    ...
    public Husbandry withAdvancements(String advancements) {
        this.advancements = advancements;
        return this;
    }
    ...
    public Husbandry withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Husbandry) == false) {
            return false;
        }
        Husbandry rhs = ((Husbandry) other);
