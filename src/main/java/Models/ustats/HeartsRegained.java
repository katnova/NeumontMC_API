...
public class HeartsRegained implements Serializable
{
    ...
    private final static long serialVersionUID = -8561543400315026529L;
    ...
    public HeartsRegained withAmount(Double amount) {
        this.amount = amount;
        return this;
    }
    ...
    public HeartsRegained withReasons(String reasons) {
        this.reasons = reasons;
        return this;
    }
    ...
    public HeartsRegained withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HeartsRegained) == false) {
            return false;
        }
        HeartsRegained rhs = ((HeartsRegained) other);
