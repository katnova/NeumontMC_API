...
public class PlayersTeleported implements Serializable
{
    ...
    private final static long serialVersionUID = 353753129896249589L;
    ...
    public PlayersTeleported withAmount(Long amount) {
        this.amount = amount;
        return this;
    }
    ...
    public PlayersTeleported withPlayers(String players) {
        this.players = players;
        return this;
    }
    ...
    public PlayersTeleported withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PlayersTeleported) == false) {
            return false;
        }
        PlayersTeleported rhs = ((PlayersTeleported) other);
