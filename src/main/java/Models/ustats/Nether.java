...
public class Nether implements Serializable
{
    ...
    private final static long serialVersionUID = 5149891218399688773L;
    ...
    public Nether withAmount(Long amount) {
        this.amount = amount;
        return this;
    }
    ...
    public Nether withAdvancements(String advancements) {
        this.advancements = advancements;
        return this;
    }
    ...
    public Nether withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Nether) == false) {
            return false;
        }
        Nether rhs = ((Nether) other);
