...
public class TimesJoined implements Serializable
{
    ...
    private final static long serialVersionUID = 8003268041439452104L;
    ...
    public TimesJoined withAmount(Long amount) {
        this.amount = amount;
        return this;
    }
    ...
    public TimesJoined withLastDate(String lastDate) {
        this.lastDate = lastDate;
        return this;
    }
    ...
    public TimesJoined withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TimesJoined) == false) {
            return false;
        }
        TimesJoined rhs = ((TimesJoined) other);
