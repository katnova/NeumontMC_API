...
public class ItemsDropped implements Serializable
{
    ...
    private final static long serialVersionUID = -7722631890610534790L;
    ...
    public ItemsDropped withAmount(Long amount) {
        this.amount = amount;
        return this;
    }
    ...
    public ItemsDropped withItems(String items) {
        this.items = items;
        return this;
    }
    ...
    public ItemsDropped withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ItemsDropped) == false) {
            return false;
        }
        ItemsDropped rhs = ((ItemsDropped) other);
