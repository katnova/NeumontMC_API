...
public class Percentage implements Serializable
{
    ...
    private final static long serialVersionUID = -5278867711661589599L;
    ...
    public Percentage withAmount(Long amount) {
        this.amount = amount;
        return this;
    }
    ...
    public Percentage withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Percentage) == false) {
            return false;
        }
        Percentage rhs = ((Percentage) other);
