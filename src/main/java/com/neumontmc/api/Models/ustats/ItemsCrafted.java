...
public class ItemsCrafted implements Serializable
{
    ...
    private final static long serialVersionUID = -4313424756066829646L;
    ...
    public ItemsCrafted withAmount(Long amount) {
        this.amount = amount;
        return this;
    }
    ...
    public ItemsCrafted withItems(String items) {
        this.items = items;
        return this;
    }
    ...
    public ItemsCrafted withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ItemsCrafted) == false) {
            return false;
        }
        ItemsCrafted rhs = ((ItemsCrafted) other);
