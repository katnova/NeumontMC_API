...
public class HitsMissed implements Serializable
{
    ...
    private final static long serialVersionUID = -5668075319675635126L;
    ...
    public HitsMissed withAmount(Long amount) {
        this.amount = amount;
        return this;
    }
    ...
    public HitsMissed withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HitsMissed) == false) {
            return false;
        }
        HitsMissed rhs = ((HitsMissed) other);
