...
public class End implements Serializable
{
    ...
    private final static long serialVersionUID = 6629903807954364615L;
    ...
    public End withAmount(Long amount) {
        this.amount = amount;
        return this;
    }
    ...
    public End withAdvancements(String advancements) {
        this.advancements = advancements;
        return this;
    }
    ...
    public End withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
