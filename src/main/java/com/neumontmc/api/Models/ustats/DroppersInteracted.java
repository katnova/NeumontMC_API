...
public class DroppersInteracted implements Serializable
{
    ...
    private final static long serialVersionUID = 3125787390253485112L;
    ...
    public DroppersInteracted withAmount(Long amount) {
        this.amount = amount;
        return this;
    }
    ...
    public DroppersInteracted withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DroppersInteracted) == false) {
            return false;
        }
        DroppersInteracted rhs = ((DroppersInteracted) other);
