...
public class HoppersInteracted implements Serializable
{
    ...
    private final static long serialVersionUID = 5874047294004934832L;
    ...
    public HoppersInteracted withAmount(Long amount) {
        this.amount = amount;
        return this;
    }
    ...
    public HoppersInteracted withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HoppersInteracted) == false) {
            return false;
        }
        HoppersInteracted rhs = ((HoppersInteracted) other);
